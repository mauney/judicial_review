...
footer = dbc.Container(
    dbc.Row(
        dbc.Col(
            html.P(
                [
                    html.Span('Matthew Mauney', className='mr-2'), 
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:r.m.mauney@gmail.com'), 
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/mauney/judicial_review'), 
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://www.linkedin.com/in/matthew-mauney-0707644//'), 
                    html.A(html.I(className='fab fa-twitter-square mr-1'), href='https://twitter.com/ProbablyMauney'), 
                ], 
                className='lead'
            )
        )
